""" Modification of the standard example convolutional_mlp.py"""
import os
...
"""Does the same as evaluate_lenet5, but instead of pickled file input,
takes it in directly as input.

:type input_data: class theano dataset
:param input_data: The data got after unpickling, shared etc
...
train_filename ='../data/Paintings/two_class/big/Paintings_train_grey.csv'
test_filename = '../data/Paintings/two_class/big/Paintings_test_grey.csv'
...
# or (500, 50 * 13 * 13) = (500, 8450) with the our custom values.
